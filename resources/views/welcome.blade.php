...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>SafePath - Your Safety Companion</title> {{-- Judul Halaman --}}
        ...
        <style>
            ...
            /* Kelas CSS untuk header saat di-scroll dan menjadi solid */
            /* Style untuk header saat TIDAK di-scroll (awal) */
            /* Style untuk header saat TIDAK di-scroll (awal) */
            #mainWelcomeHeader {
            ...
            /* Kelas CSS untuk header saat di-scroll */
            #mainWelcomeHeader.scrolled {
                /* Menggunakan background-image untuk gradasi dengan RGBA untuk transparansi */
                background-image: linear-gradient(to right, rgba(203, 91, 255, 0.2), rgba(231, 121, 56, 0.2)); /* Gradasi dari primary ke accent-orange dengan 85% opacity */
                backdrop-filter: blur(12px); /* Efek blur, sesuaikan nilainya jika perlu (misal 8px, 16px) */
                -webkit-backdrop-filter: blur(12px); /* Untuk kompatibilitas Safari */
                box-shadow: 0 2px 4px 0 rgba(0, 0, 0, 0.05); /* Shadow tipis */
            }
        </style>
    </head>
    <body class="font-sans antialiased text-text-main bg-gradient-to-r from-header-light to-primary backdrop-blur-sm shadow">
        <div class="min-h-screen flex flex-col">

    {{-- Latar belakang gradasi untuk seluruh body --}}
    <body class="font-sans antialiased text-text-main bg-gradient-to-r from-header-light to-primary">
        {{-- Pastikan 'header-light' dan 'primary' ada di tailwind.config.js untuk gradasi body --}}
        <div class="min-h-screen flex flex-col">
            ...
            <main id="hero" class="h-screen flex flex-col items-center justify-center text-center text-white p-6 pt-0">
                <div class="max-w-2xl pt-8 pb-16 lg:pt-6 lg:pb-25">
                    ...
                    <h1 class="text-8xl sm:text-7xl mb-6 text-center"> {{-- text-center untuk menengahkan semua --}}
                        <span class="font-extrabold text-white">Safe</span><span class="font-normal text-white">Path</span>
                    </h1>

                    <p class="text-lg italic text-gray-200 mb-8"> {{-- 'font-italic' diubah menjadi 'italic' --}}
                        Langkah Kecil, Perlindungan Besar
                    </p>

                    {{-- Tombol "Learn More" untuk scroll ke About Us --}}
                    <a href="#about-us" 
                    class="mt-2 inline-block 
                            bg-white bg-opacity-10 {{-- Latar putih dengan opasitas 75% --}}
                            hover:bg-opacity-30 {{-- Opasitas hover sedikit lebih solid --}}
                            text-white {{-- Teks tetap ungu agar kontras dengan latar gradasi di belakangnya --}}
                            font-medium py-3 px-8 
                            text-lg 
                            transition-all duration-300 ease-in-out {{-- transition-all agar opacity juga transisi --}}
            ...
            <section id="meet-our-team" class="pt-16 pb-24 lg:pt-24 lg:pb-32 bg-background-main relative z-10">
                <div class="max-w-7xl mx-auto px-6 lg:px-8 text-center">
                    ...
                    {{-- Grid container untuk anggota tim --}}
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-12 sm:gap-x-8">
                        ...
                        <div class="flex flex-col items-center">
                            {{-- DIUBAH: dari rounded-full menjadi rounded-xl --}}
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center md:items-start gap-10 text-center md:text-left">
                        ...
                        <div class="flex flex-col items-center md:items-start">
                            <a href="{{ url('/') }}" class="flex items-center gap-3 mb-4">
                                {{-- Gunakan logo versi putih agar kontras dengan background gelap --}}
                        ...
                        <div>
                            ...
                            <div class="flex flex-col items-center md:items-start gap-3">
                                ...
                                <a href="https://wa.me/6285229532952" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 hover:text-white transition-colors duration-300">
                                    ...
                                    <span>+62 852-2953-2952</span> {{-- Placeholder --}}
                                </a>
                                ...
                                <a href="https://www.instagram.com/safepath.official" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 hover:text-white transition-colors duration-300">
                                    ...
                                    <span>@safepath.official</span> {{-- Placeholder --}}
                                </a>
                            </div>
                        </div>
